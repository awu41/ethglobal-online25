...
async function main() {
  console.log("🚀 Deploying Research Prediction Market to Sepolia...");
  ...
  // For Sepolia, we'll use a mock USDC address
  // In production, this would be the real USDC contract address
  ...
  console.log("\n⚠️  Note: This is basic contract testing. For full Yellow SDK demo, deploy to Nitrolite testnet.");
}
